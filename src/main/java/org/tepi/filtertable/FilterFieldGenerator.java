...
class FilterFieldGenerator {
    ...
    private Filter generateFilter(Property field, Object propertyId,
        ...
        if (field instanceof DateFilterPopup) {
            ...
            if (owner.getFilterGenerator() != null) {
                Filter newFilter = owner.getFilterGenerator().generateFilter(propertyId,
                        interval);
                if (newFilter != null) {
                    return newFilter;
                }
            ...
            try {
            	...
            	if (eqValue != null) {
                    ...
                    return new And(new Compare.Less(propertyId, valueOf.invoke(clazz, ltValue))
    ...
    private AbstractField createField(Object property, Class<?> type) {
        ...
        if (component != null) {
            ...
            component = createBooleanField(property);
                ...
                || type == Float.class || type == Double.class || type == int.class || type == long.class
