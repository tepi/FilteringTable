...
import com.vaadin.terminal.gwt.client.ui.VCustomTreeTable.VTreeTableScrollBody.VTreeTableRow;

public class VCustomTreeTable extends VCustomScrollTable {
    ...
    private LinkedList<PendingNavigationEvent> pendingNavigationEvents = new LinkedList<VCustomTreeTable.PendingNavigationEvent>();
